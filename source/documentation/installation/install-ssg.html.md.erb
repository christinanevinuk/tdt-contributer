...
The Middleman SSG is used with the Government Digital Services' (GDS) Technical Documentation Template (TDT). To install the TDT see see [**Template installation**](/documentation/installation/install-template.html.md.erb) for details.
